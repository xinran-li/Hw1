...
The numbers give an argument that the commond has to obey. The argument usually has the x and y axis to set up the initrial location. And then the numbers shows the weith and highth, even radious and so on.
